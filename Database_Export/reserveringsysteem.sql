...
--
CREATE DATABASE IF NOT EXISTS `reserveringsysteem` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
--
ALTER TABLE `accommodations`
  MODIFY `AccommodationId` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `prices`
  MODIFY `PriceId` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
