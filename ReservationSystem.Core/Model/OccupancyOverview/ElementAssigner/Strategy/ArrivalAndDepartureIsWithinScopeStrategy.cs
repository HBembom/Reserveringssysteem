...
{
    internal class ArrivalAndDepartureIsWithinScopeStrategy : IAssignElement
    {
        private Grid _grid;
        private Reservation _reservation;
        private Scope _scope;

        public ArrivalAndDepartureIsWithinScopeStrategy(Grid grid, Reservation reservation, Scope scope)
        {
            this._grid = grid;
