...
{
    public class OccupancyOverviewRetry
    {
        ...
        public OccupancyOverviewRetry(int accomodations, List<Reservation> reservations, Grid grid, DateTime selectedWeek)
        {
            this.AmmountOfAccommodations = accomodations;
            this.Reservations = reservations;
            _grid = grid;
            this.SelectedWeek = selectedWeek.AddDays(2);
